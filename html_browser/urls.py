...
urlpatterns = [
    ...
    url(r'editUserAction/.*', admin_views.EditUserActionView.as_view(), name='editUserAction'),
    ...
    url(r'addUserAction/.*', admin_views.AddUserActionView.as_view(), name='addUserAction'),
