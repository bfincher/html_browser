...
urlpatterns = patterns('html_browser.views',
    ...
    url(r'userAdminAction/.*', 'userAdminAction'),
    url(r'editUser/.*', 'editUser'),
    url(r'addUser/.*', 'addUser'),
    url(r'editGroup/.*', 'editGroup'),
    url(r'folderAdmin/.*', 'folderAdmin'),
    url(r'folderAdminAction/.*', 'folderAdminAction'),
    url(r'editFolder/.*', 'editFolder'),
    url(r'addFolder/.*', 'addFolder'),
    url(r'groupAdmin/.*', 'groupAdmin'),
    url(r'groupAdminAction/.*', 'groupAdminAction'),
    ...
    url(r'getNextImage', 'getNextImage'),
